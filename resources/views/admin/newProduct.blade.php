        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="{{ route('adminNewProduct') }}" method="post" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                          <div class="row">
                              <div class="col-md-8">
                          ...
                          <div class="row mt-4">
                              <div class="col-md-8">
                                  <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="description" id="" rows="10" cols="30" placeholder="Product description"></textarea>
                                  </div>
                              </div>
                          </div>
